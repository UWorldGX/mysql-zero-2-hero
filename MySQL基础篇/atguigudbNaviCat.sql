...
CREATE TABLE `countries`  (
  `country_id` char(2) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `country_name` varchar(40) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `region_id` int NULL DEFAULT NULL,
  PRIMARY KEY (`country_id`) USING BTREE,
  INDEX `countr_reg_fk`(`region_id` ASC) USING BTREE,
...
CREATE TABLE `departments`  (
  ...
  `department_name` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `manager_id` int NULL DEFAULT NULL,
  `location_id` int NULL DEFAULT NULL,
  PRIMARY KEY (`department_id`) USING BTREE,
  UNIQUE INDEX `dept_id_pk`(`department_id` ASC) USING BTREE,
  INDEX `dept_loc_fk`(`location_id` ASC) USING BTREE,
  INDEX `dept_mgr_fk`(`manager_id` ASC) USING BTREE,
...
CREATE TABLE `employees`  (
  ...
  `first_name` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  ...
  `job_id` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `salary` double(8, 2) NULL DEFAULT NULL,
  `commission_pct` double(2, 2) NULL DEFAULT NULL,
  `manager_id` int NULL DEFAULT NULL,
  `department_id` int NULL DEFAULT NULL,
  PRIMARY KEY (`employee_id`) USING BTREE,
  UNIQUE INDEX `emp_email_uk`(`email` ASC) USING BTREE,
  UNIQUE INDEX `emp_emp_id_pk`(`employee_id` ASC) USING BTREE,
  INDEX `emp_dept_fk`(`department_id` ASC) USING BTREE,
  INDEX `emp_job_fk`(`job_id` ASC) USING BTREE,
  INDEX `emp_manager_fk`(`manager_id` ASC) USING BTREE,
...
CREATE TABLE `job_grades`  (
  `grade_level` varchar(3) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `lowest_sal` int NULL DEFAULT NULL,
  `highest_sal` int NULL DEFAULT NULL
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `job_history`  (
  ...
  UNIQUE INDEX `jhist_emp_id_st_date_pk`(`employee_id` ASC, `start_date` ASC) USING BTREE,
  INDEX `jhist_job_fk`(`job_id` ASC) USING BTREE,
  INDEX `jhist_dept_fk`(`department_id` ASC) USING BTREE,
...
CREATE TABLE `jobs`  (
  `job_id` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '',
  `job_title` varchar(35) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
...
CREATE TABLE `locations`  (
  ...
  `street_address` varchar(40) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `postal_code` varchar(12) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `city` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `state_province` varchar(25) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `country_id` char(2) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`location_id`) USING BTREE,
  UNIQUE INDEX `loc_id_pk`(`location_id` ASC) USING BTREE,
  INDEX `loc_c_id_fk`(`country_id` ASC) USING BTREE,
...
CREATE TABLE `order`  (
  ...
  `order_name` varchar(15) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of order
-- ----------------------------
INSERT INTO `order` VALUES (1, 'shkstart');
INSERT INTO `order` VALUES (2, 'tomcat');
INSERT INTO `order` VALUES (3, 'dubbo');
...
CREATE TABLE `regions`  (
  ...
  `region_name` varchar(25) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`region_id`) USING BTREE,
  UNIQUE INDEX `reg_id_pk`(`region_id` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci ROW_FORMAT = Dynamic;
